...
export  function RegistrationScreen2({navigation}) {
            ...
            <LinearGradient start={{x:-0.15, y:-0.15}} end={{x: 1, y: 1}} style={styles.container }  colors={['#9900cc', '#6666ff']}>
                <View>
                    ...
                    <View style={styles.inputPlace}>
                        ...
                        size={28} 
                        color="#fff"/>   
                        <TextInput dataDetectorTypes={'phoneNumber'} defaultValue={""} placeholder={'123456'}  maxLength={6} style={styles.input}  keyboardType='decimal-pad'/>
                    </View>
                    </KeyboardAvoidingView>
                    <View style={styles.buttonPlace}>
                        <FlatButton   text="Продолжить" onPress={()=>navigation.push("Reg3")}/>
                    </View>
                    <View style={styles.mbuttonPlace}>
                        <FlatButton2   text="Отправить ещё раз" onPress={()=>{}}/>
                    </View>
                </View>
            </LinearGradient>
        );
